        ...
        <div>
            ...
            <footer class="bg-white dark:bg-brandPrimary">
                <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        ...
                        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul class="text-neutralSilver font-medium">
                                    <li class="mb-4">
                                        <a href="#" class="hover:underline">Core Values</a>
                                    </li>
                                    <li>
                    ...
                    <hr class="my-6 border-gray-200 sm:mx-auto dark:border-neutralSilver lg:my-8" />
                    <div class="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="flex mt-4 sm:justify-center sm:mt-0">
                            <a href="#" class="text-neutralSilver hover:text-gray-900 dark:hover:text-white">
                                <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                    <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd" />
                                </svg>
                                <span class="sr-only">Facebook page</span>
                            </a>
                            <a href="#" class="text-neutralSilver hover:text-gray-900 dark:hover:text-white ms-5">
